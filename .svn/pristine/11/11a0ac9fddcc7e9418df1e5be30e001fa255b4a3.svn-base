...
public class UserLogManager implements ActionListener{
    ...
    */
     ...
     * Get the date the user has selected to log data
     *
     * @param   The date the user has selected to log data
     */
    public void setDate(Date date)
    {
        // set the date in UserLog
    }
    ...
    {
        // get the calorie limit from user log
